...
export default function BusRouteList() {
    ...
    >
      <td>
        <div className="d-flex align-items-center position-relative justify-content-start">
          <div
            className="d-inline col-5 align-items-center"
            style={{ fontWeight: "Bold", fontSize: "20px" }}
          >
            {t.RouteID}
          </div>
          <div className="d-inline col-7 align-items-center">
            {t.LineDescription}
          </div>
        </div>
      </td>
    ...
    <tr key={index}>
      <td className="align-middle">
        <div className="align-items-center placeholder-glow">
          <span
            className="align-items-center placeholder col-7"
            style={{ height: "17px" }}
          ></span>
        </div>
      </td>
  ...
  return (
    <div style={{ height: "100%", backgroundColor: "white" }}>
      ...
      <div ref={elementRef}>
        <ul className="nav nav-tabs justify-content-center nav-fill d-md-none  nav-justified">
          <li id="map-tab" className="nav-item">
            <a className="nav-link" href="#map" data-bs-toggle="tab">
              Map
            </a>
          </li>
      ...
      <div
        className="tab-content d-flex row m-0 p-0"
        style={{ height: `calc(100% - 61px - ${height}px)` }}
      >
        <div
          id="map"
          className="col d-md-block tab-pane col-lg-6 col-md-6 m-0 p-0"
          style={{ height: "100%" }}
        >
        ...
        <div
          id="info"
          className="col tab-pane active show col-lg-6 col-md-6 overflow-auto"
          style={{ height: "100%" }}
        >
          {route.length ? (
            <BusRoute
              set_center_to={set_center_to}
              set_active_stops={set_active_stops}
