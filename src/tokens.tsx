...
export const API_URL = (!process.env.NODE_ENV || process.env.NODE_ENV === 'development') ? process.env.REACT_APP_API_URL : 'https://wmata-backend.onrender.com'
/*
if (!process.env.NODE_ENV || process.env.NODE_ENV === 'development') {
    API_URL = process.env.REACT_APP_API_URL
} else {
    API_URL = 'https://wmata-backend.onrender.com'
}*/
export * from './tokens'